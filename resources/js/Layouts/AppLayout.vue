                            ...
                            <nav class="flex h-full flex-col">
                                <div class="space-y-1">
                                    ...
                                    <a href="#"
                                        ...
                                        aria-current="page">
                                        <svg class="text-white mr-3 h-6 w-6" fill="none" viewBox="0 0 24 24"
                    ...
                    <div class="relative z-10 flex h-16 flex-shrink-0 border-b border-gray-200 bg-white shadow-sm">
                        ...
                        <div class="flex flex-1 justify-between px-4 sm:px-6">
                            ...
                            <div class="ml-2 flex items-center space-x-4 sm:ml-6 sm:space-x-6">
                                ...
                                <div>
                                    <button @click="profileMenu=!profileMenu" type="button"
                                ...
                                <div v-if="profileMenu" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
