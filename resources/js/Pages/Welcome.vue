...
<template>
    ...
    <div class="bg-white">
          <div class="relative overflow-hidden">
                ...
                <nav class="relative mx-auto flex max-w-7xl items-center justify-between px-6" aria-label="Global">
                  <div class="flex flex-1 items-center">
                    ...
                    <div class="hidden space-x-8 md:ml-10 md:flex">
                      ...
                      <a href="#" class="text-base font-medium text-white hover:text-gray-300">Contacts</a>
                    </div>
                  </div>

                  <div v-if="canLogin">
                      <div v-if="$page.props.auth.user" class="hidden md:flex md:items-center md:space-x-6">
                            <Link :href="route('dashboard')" class="text-base font-medium text-white hover:text-gray-300">Dashboard</Link>
                      </div>
                      ...
                      <div v-else class="hidden md:flex md:items-center md:space-x-6">
                        ...
                        <Link :href="route('register')" class="inline-flex items-center rounded-md border border-transparent bg-gray-600 px-4 py-2 text-base font-medium text-white hover:bg-gray-700">Start free trial</Link>
                      </div>
                  </div>
            ...
            <main>
              <div class="min-h-screen bg-gray-900 pt-10 sm:pt-16 lg:overflow-hidden lg:pt-8 lg:pb-14">
                    ...
                    <div class="mx-auto max-w-md px-6 sm:max-w-2xl sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                      <div class="lg:py-24">
                        ...
                        <h1 class="mt-4 text-4xl font-bold tracking-tight text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                          <span class="block">BILL</span>
                          <span class="block bg-gradient-to-r from-teal-200 to-cyan-400 bg-clip-text pb-3 text-transparent sm:pb-5">FLOW</span>
                        </h1>
                        <p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                            All in one accounting and book keeping software. <br>
                            Helping businesses maintain a seamless flow of transactions.
                        </p>
